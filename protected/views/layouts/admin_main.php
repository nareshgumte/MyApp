                    ...
                    <div class="container">  
                        <ul class="nav">  
                            ...
                            <?php if (!Yii::app()->user->isGuest) { ?>
                                <li><?php echo CHtml::link('Home', array('/admin/home')); ?></li>  
                                <li><?php echo CHtml::link('ManageUsers', array('/admin/Users')); ?></li>  
                                <li><?php echo CHtml::link('change password', array('/admin/changePassword')); ?></li>  
                                <li><?php echo CHtml::link('Logout (' . Yii::app()->user->name . ')', array('/admin/logout')); ?></li> 
                                <?php
                            }else
                                echo "";
                            ?>
