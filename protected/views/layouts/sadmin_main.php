                    ...
                    <div class="container">  
                        <ul class="nav">  
                            ...
                            <?php if (!Yii::app()->user->isGuest) { ?>
                                <li> <?php echo CHtml::link('ManageAdmins', array('/superAdmin/Admins')); ?></li>
                                <li><?php echo CHtml::link('ManageUsers', array('/superAdmin/Users')); ?></li>  
                                <li><?php echo CHtml::link('change password', array('/superAdmin/changePassword')); ?></li>  
                                <li><?php echo CHtml::link('Logout (' . Yii::app()->user->name . ')', array('/superAdmin/logout')); ?></li> 
                                <?php
                            }
                            else
                                echo "";
