...
class SuperAdminController extends Controller {
     ...
     */
    public $layout = '//layouts/sadmin_main';
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('create', 'update','users','logout','ChangePassword','admins','admin'),
                'users' => array('@'),
            ),
...
//		$dataProvider=new CActiveDataProvider('IntLogin');
//		$this->render('index',array(
//			'dataProvider'=>$dataProvider,
//		));


        $model = new LoginForm("SAdmin");
        ...
        if (isset($_POST['LoginForm'])) {
            ...
            if ($model->validate() && $model->login())
                $this->redirect(Yii::app()->homeUrl . "superAdmin/users");
        }
    ...
    public function actionLogout() {
        Yii::app()->user->logout();
        $this->redirect(Yii::app()->homeUrl . "superAdmin");
